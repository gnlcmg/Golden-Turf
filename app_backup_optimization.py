"""
Golden Turf Flask Application - Business management system for turf services
Provides user management, client tracking, invoicing, scheduling, and product catalog.
Enhanced with VCE Units 3/4 programming concepts for educational assessment.
# Core Imports
